...
namespace CMB_CashPortal.Controllers
{
    public class TransactionTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type")] TransactionType transactionType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type")] TransactionType transactionType)
        {
            if (ModelState.IsValid)
            {
