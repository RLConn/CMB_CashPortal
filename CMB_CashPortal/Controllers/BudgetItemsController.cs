...
namespace CMB_CashPortal.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetId,Name,Description,Target,Actual")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetId,Name,Description,Target,Actual")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
